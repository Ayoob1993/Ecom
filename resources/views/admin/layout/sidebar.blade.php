<nav class="sidebar sidebar-offcanvas" id="sidebar">
    <ul class="nav">
      ...
      @if (Auth::guard('admin')->user()->type=="vendor")
        <li class="nav-item">
            ...
            <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="{{ url('update_vendor_details/personal') }}">Personal Details</a></li>
                <li class="nav-item"> <a class="nav-link" href="{{ url('update_vendor_details/business') }}">Business Details</a></li>
                <li class="nav-item"> <a class="nav-link" href="{{ url('update_vendor_details/bank') }}">Bank Details</a></li>
            </ul>
            </div>
        </li>
      @else
      <li class="nav-item">
        ...
        <div class="collapse" id="ui-basic">
          <ul class="nav flex-column sub-menu">
            <li class="nav-item"> <a class="nav-link" href="{{ url('update_admin_password') }}">Update Password</a></li>
            <li class="nav-item"> <a class="nav-link" href="{{ url('update_admin_details') }}">Update Details</a></li>
          </ul>
        </div>
      </li>
      @endif
